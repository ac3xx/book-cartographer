...
from epub_character_graph.config import (
    AppConfig,
    get_config,
)
from epub_character_graph.epub_parser import EPUBParser
from epub_character_graph.nlp.entity_extractor import EntityExtractor
from epub_character_graph.nlp.llm_processor import LLMProcessor
from epub_character_graph.output_generators.base import OutputGeneratorConfig
from epub_character_graph.output_generators.image_prompt import ImagePromptGenerator
from epub_character_graph.output_generators.kodict import KODictGenerator
from epub_character_graph.utils import (
...
def series_init_command(series_name: str, author: Optional[str], output: Optional[Path]) -> None:
    ...
    """
    from epub_character_graph.series_graph import SeriesGraph
