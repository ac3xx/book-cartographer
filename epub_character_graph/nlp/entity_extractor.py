...
from epub_character_graph.config import ProcessingConfig
from epub_character_graph.nlp.llm_processor import LLMProcessor
from epub_character_graph.nlp.prompts import LLM_ENTITY_EXTRACTION_PROMPT
...
class EntityExtractor:
    ...
    async def _extract_entities_with_llm(self, text: str, title: str, author: str) -> Dict[str, Set[str]]:
        ...
        """
        from epub_character_graph.nlp.prompts import generate_llm_entity_extraction_prompt
        import json
        import time
